...
public class PersistenceWithJDBCServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		response.getWriter().println("<p>Persistence with JDBC elo!</p>");
		try {
	...
	private void doAdd(HttpServletRequest request) throws ServletException,
			IOException, SQLException, IllegalStateException, SecurityException, NotSupportedException, SystemException, HeuristicMixedException, HeuristicRollbackException, RollbackException {
